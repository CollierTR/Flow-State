...
function App() {
  ...
  function handleChange(e) {
    ...
    inputRef.current.value
      ? setFocusPoint(inputRef.current.value)
      : "Set a Value";
    ...
    <div className="relative">
      <div className="w-3/4 mx-auto flex flex-col gap-6 lg:gap-8 justify-center place-items-center text-white text-center text-pretty h-screen">
        ...
        <p
          ...
          className="cursor-pointer text-6xl lg:text-8xl text-red-800"
        >
          {focusPoint}
        </p>
        ...
        >
          <form
            ...
            className="flex-col gap-4 place-items-center justify-center"
          >
